...
INSERT INTO employees (name, department_id) VALUES ('Иванов Иван', 1);
INSERT INTO employees (name, department_id) VALUES ('Петров Петр', 2);
...
INSERT INTO employees (name, department_id) VALUES ('Сидоров Сидор', NEW_DEPARTMENT_ID);
INSERT INTO employees (name, department_id) VALUES ('Козлов Константин', NEW_DEPARTMENT_ID);
...
INSERT INTO orders (customer_name, order_date) VALUES ('Иванов Иван', '2022-01-01');

--Транзакция для добавления нового заказа и товаров в него:

BEGIN;

INSERT INTO orders (customer_name, order_date) VALUES ('Петров Петр', '2022-02-01');
